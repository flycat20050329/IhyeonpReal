<template>
  <div class="container">
    <Card v-for="(item, index) in stack" :src="item.cover" :scale="item.imageScale" :speed="speed"
      :isDragging="isDragging" :isSelected="index === 1 && isDetailView" :opacity="item.imageOpacity" :key="item._uuid"
      :style="{
