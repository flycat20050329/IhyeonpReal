<template>
  <div id="app">
    ...
    <!-- <nav class="navbar navbar-expand-lg pt-3 pb-1">
    <div class="col-2">
    ...
    <ul id="menu">
      ...
      <li>
        <a href="/login" rel="noopener" class="twitter-share">
          <i>
    ...
    <full-page :options="this.options" id="fullpage" ref="fullpage">
      <div class="section">
        <h1>Section 1</h1>
        <button @click="Please">Primary</button>
      </div>
      <div class="section">
  ...
  data() {
    return {
      options: {
        ...
        sectionsColor: ['#FCFCFC', '#FF000000', '#FF000000', '#fec401', '#1bcee6', '#ee1a59', '#2c3e4f', '#ba5be9', '#b4b8ab']
      }
    }
  },
  mounted() {
