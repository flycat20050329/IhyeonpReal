        ...
        <ul class="navbar-nav justify-content-end">
          ...
          <li class="px-3 nav-item d-flex align-items-center">
            <a
              ...
              :class="color ? color : 'text-body'"
            >
              <i class="material-icons fixed-plugin-button-nav cursor-pointer" data-bs-toggle="modal" data-bs-target="#YamlFileModal">
                settings
              </i>
            </a>
          </li>
      ...
      if(this.isPlay){
        axios.get('api/off')
          .then(response => {
              ...
              this.materialAppIcon = "play_circle";
              this.isPlay = false;
        ...
        axios.get('api/on')
          .then(response => {
              // JSON responses are automatically parsed.
              this.materialAppIcon = "pause_circle";
              this.isPlay = true;
